...
class StudentController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'grade_id' => 'nullable|exists:grades,id',
            'parents_id' => 'nullable|exists:parents,id', // Standardized key to match database column
            'parent_id' => 'nullable|exists:parents,id',  // Fallback support for parent_id
        ...
        try {
            ...
            $student = Student::create([
                ...
                'parents_id' => $request->parents_id ?? $request->parent_id,
    ...
    public function update(Request $request, $id)
    {
        try {
            $validator = Validator::make(array_merge(['id' => $id], $request->all()), [
                ...
                'parents_id' => 'sometimes|nullable|exists:parents,id',
            ...
            // Support either parent_id or parents_id in request payload
            if (isset($data['parent_id']) && !isset($data['parents_id'])) {
                $data['parents_id'] = $data['parent_id'];
                unset($data['parent_id']);
            }

            // Capitalize gender consistently if provided
